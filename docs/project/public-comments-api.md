...
[working with your agent](../agents/public-comments.md#configure-trusted-actors). A read that
...
[trust-config limits](../agents/public-comments.md#configure-trusted-actors) explain.
