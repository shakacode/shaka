...
| Project constraints, review criteria, and existing style-file pointers | `AGENTS.md` |
| Persistent writing defaults | [Writing preferences](writing-preferences.md) in `.agents/writing-style.md` |
