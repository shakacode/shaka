...
names. It supplies setup, validation, focused tests, base branch, review, merge, and
branch-protection policy. `AGENTS.md` supplies human-only context and boundaries.
