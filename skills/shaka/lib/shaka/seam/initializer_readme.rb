    ...
    module InitializerReadme
      ...
      def readme_source
        <<~MARKDOWN
          ...
          - [Configuration](#{DOCS}/configuration.md) — every key, its type, and what it controls.
          - [Getting started](#{DOCS}/getting-started.md#configure-a-repository) — how this directory was created.
