    ...
    module InitializerReadme
      ...
      def readme_source
        <<~MARKDOWN
          ...
          - [Seam settings](#{DOCS}/agents/settings.md) — every key, its type, and what it controls.
          - [Getting started](#{DOCS}/people/getting-started.md#initialize-a-repository-seam) — how this directory was created.
