...
earlier commit when a merge or rebase from the base left the PR's own patches
identical, apart from hunk positions in files the base update changed, or when every later change is Markdown other
