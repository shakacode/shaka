...
class CliTest < Minitest::Test
  ...
  def test_help_explains_each_operation
    ...
    operations = %w[pr comments description reply resolve walkthrough merge recommendation checkpoint seam
                    doctor enforcement repos prefix]
    (operations + %w[--head --issue --content-file --key --comment --thread --ci-review-wait --ref]).each do |token|
