...
- [Developing Shaka](development.md) — setup, checks, and source layout.
- [Configuration internals](configuration-internals.md) — parsers and policy boundaries.
- [Packaging](packaging.md) — package contents and installation checks.
